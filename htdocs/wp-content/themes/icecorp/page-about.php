									...
									<td class="company-table-desc">
										<div class="client-list">
											<ul class="client-list-inner">
												<li class="client-list-item">Apple Inc.</li>
												<li class="client-list-item">Amazon Service International Inc.</li>
												<li class="client-list-item">株式会社アムタス</li>
												<li class="client-list-item">NTTソルマーレ株式会社</li>
												<li class="client-list-item">株式会社NTTドコモ</li>
												<li class="client-list-item">株式会社講談社</li>
												<li class="client-list-item">株式会社集英社</li>
												<li class="client-list-item">株式会社出版デジタル機構</li>
												<li class="client-list-item">株式会社小学館</li>
												<li class="client-list-item">株式会社世界文化社</li>
												<li class="client-list-item">株式会社竹書房</li>
												<li class="client-list-item">株式会社DNPコミュニケーションデザイン</li>
												<li class="client-list-item">株式会社東京創元社</li>
												<li class="client-list-item">図書印刷株式会社</li>
												<li class="client-list-item">株式会社ナンバーナイン</li>
												<li class="client-list-item">株式会社パピレス</li>
												<li class="client-list-item">株式会社PHP研究所</li>
												<li class="client-list-item">株式会社双葉社</li>
												<li class="client-list-item">株式会社ブックリスタ</li>
												<li class="client-list-item">株式会社メディアドゥ</li>
												<li class="client-list-item">株式会社モバイルブック・ジェーピー</li>
												<li class="client-list-item">楽天株式会社</li>
												<li class="client-list-item">株式会社ワニブックス</li>
												<li class="client-list-item">（50音順）</li>
												<li class="client-list-item">※一部に弊社グループ企業との取引も含まれます</li>
											</ul>
										</div>
									</td>
								</tr>
